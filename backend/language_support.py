...
MISSION_SAMPLE_ANSWERS: dict[str, dict[str, str]] = {
    "english": {
        "intro": "Hi, my name is Cyrus. I study at VTC in Hong Kong, and I enjoy listening to music after class.",
    ...
    "french": {
        "intro": "Bonjour, je m'appelle Cyrus. J'étudie au VTC à Hong Kong et j'aime écouter de la musique après les cours.",
    ...
    "italian": {
        "intro": "Ciao, mi chiamo Cyrus. Studio al VTC di Hong Kong e mi piace ascoltare musica dopo le lezioni.",
    ...
    "german": {
        "intro": "Hallo, ich heiße Cyrus. Ich lerne am VTC in Hongkong und höre nach dem Unterricht gern Musik.",
    ...
    "spanish": {
        "intro": "Hola, me llamo Cyrus. Estudio en VTC en Hong Kong y me gusta escuchar música después de clase.",
    ...
    "portuguese": {
        "intro": "Olá, meu nome é Cyrus. Eu estudo no VTC em Hong Kong e gosto de ouvir música depois da aula.",
    ...
    "hindi": {
        "intro": "नमस्ते, मेरा नाम साइरस है। मैं हांगकांग के वीटीसी में पढ़ता हूँ और कक्षा के बाद संगीत सुनना पसंद करता हूँ।",
